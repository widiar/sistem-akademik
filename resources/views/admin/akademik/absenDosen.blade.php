...
<div class="modal fade" id="modalAdmin" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.post.absen.dosen') }}" method="POST" class="absen-form">
                @csrf
                ...
                <div class="modal-body form-group">
                    ...
                    <div class="form-group mt-3">
                        <label for="sks">Total Kehadiran (jumlah SKS)</label>
                        <input type="text" name="sks" class="form-control sks" value="">
                    </div>
                </div>
...
<script>
    ...
    let tipe = "{{ route('admin.absen.dosen') }}";
    ...
    $(".absen-button").click(function(e){
        ...
        $.ajax({
            ...
            success: function(data){
                if (data.msg == 'Tidak'){
                    Swal.fire("Oops", "Dosen ini belum diisikan SKS", "warning");
                }else{
                    $(".sks").val(data.absen)
                    $(".idDosen").val(id)
    ...
    $(".bulan").change(function(e){
        var ur = "{{ route('admin.cek.absen.dosen', [':dosen', ':bulan']) }}"
    ...
    $(".absen-form").submit(function(e){
        ...
        $.ajax({
            ...
            success: function(msg){
                ...
                else if (msg == 'Lebih') Swal.fire("Oops", "Input SKS lebih", "warning");
